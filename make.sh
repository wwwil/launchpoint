...
function build() {
    ...
    BUILD_OUTPUT="${BUILD_DIR}/${PROJECT_NAME}-${VERSION}-${BUILD_GOOS}-${BUILD_GOARCH}/${PROJECT_NAME}"
    ...
    echo "Building ${PROJECT_NAME} ${VERSION} ${BUILD_GOOS} ${BUILD_GOARCH}."
